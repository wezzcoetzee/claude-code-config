...
Keep an eye on changes to `main` and rebase when needed. If an overlapping PR makes this one obsolete, stop monitoring, report it tollthe user, and ask before closing the PR unless closure was explicitly authorized.
...
'''md
[MODEL-SLUG] RESPONDING ON BEHALF OF WESLEY
-----
[actual reply]
```
